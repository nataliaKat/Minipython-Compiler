...
public final class AAndCompComparison extends PComparison
{
    private PComparison _l_;
    private PComparison _r_;

    public AAndCompComparison()
    {
    }
    ...
    {
        ((Analysis) sw).caseAAndCompComparison(this);
    }
